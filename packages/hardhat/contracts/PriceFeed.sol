...
contract PriceFeed is MainDemoConsumerBase {
     ...
     * @dev Allows oracle data from up to 3 hours in the past or future
    ...
    function validateTimestamp(uint256 receivedTimestampMilliseconds) public view virtual override {
        ...
        // Allow data from 3 hours in the past or future (for local development)
        uint256 maxTimestampDiffMilliseconds = 3 * 60 * 60 * 1000; // 3 hours
