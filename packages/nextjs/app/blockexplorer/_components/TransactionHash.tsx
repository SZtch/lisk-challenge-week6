  ...
  return (
    <div className="flex items-center">
      ...
      {copied ? (
        ...
        <button type="button" onClick={handleCopy} aria-label="Copy transaction hash" className="ml-1.5">
          <DocumentDuplicateIcon className="text-xl font-normal text-sky-600 h-5 w-5" aria-hidden="true" />
        </button>
      )}
    </div>
  );
